...
""Grace"",""Hopper"",""10""";
        ...
        public void ToCsvDSrializesProperlyWithDefaults()
        {
            ...
            var nl = Environment.NewLine;
            Assert.Equal($"FirstName,LastName,Age{nl}Alex,Friedman,27{nl}Jack,Bauer,45{nl}Cloe,O'Brien,35{nl}John,Doe,30{nl}Grace,Hooper,18{nl}", serialized);
        }
        [Fact]
        ...
        public void ToCsvDeSrializesProperlyWithCustomQuotation()
        {
            ...
            var serialized = tested.SerializeToCsv(",", '"');
            var nl = Environment.NewLine;
            var expected = $"\"FirstName\",\"LastName\",\"Age\"{nl}\"Alex\",\"Friedman\",\"27\"{nl}\"Jack\",\"Bauer\",\"45\"{nl}\"Cloe\",\"O'Brien\",\"35\"{nl}\"John\",\"Doe\",\"30\"{nl}\"Grace\",\"Hooper\",\"18\"{nl}";
        ...
        public void ToCsvSerializesProperlyWithCustomMapping()
        {
            ...
            var nl = Environment.NewLine;
            Assert.Equal($"\"forename\",\"surname\",\"age\"{nl}\"Alex\",\"Friedman\",\"27\"{nl}\"Jack\",\"Bauer\",\"45\"{nl}\"Cloe\",\"O'Brien\",\"35\"{nl}\"John\",\"Doe\",\"30\"{nl}\"Grace\",\"Hooper\",\"18\"{nl}", serialized);
        }
